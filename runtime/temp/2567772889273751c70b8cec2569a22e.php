<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"E:\WWW\tp5shop/application/admin\view\admin\index.html";i:1480907102;s:56:"E:\WWW\tp5shop/application/admin\view\layout\layout.html";i:1480916677;}*/ ?>
<!DOCTYPE html>
...
<div class="portlet box light" style="margin-top: 10px;">
    <div class="portlet-title">
        ...
        <div class="tools">
            <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> 添加管理员</button>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <td> 超级管理员 </td>
                    <td> bj@163.com </td>
                    <td> 2016-12-10 16:32:05 </td>
                    <td>
                        <a href="javascript:;" class="btn btn-sm blue"><i class="fa fa-edit"></i>
                        </a>
