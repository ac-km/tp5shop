<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"E:\WWW\tp5shop/application/admin\view\user\levellist.html";i:1480909389;s:56:"E:\WWW\tp5shop/application/admin\view\layout\layout.html";i:1480916677;}*/ ?>
<!DOCTYPE html>
...
<div class="portlet box light" style="margin-top: 10px;">
    <div class="portlet-title">
        <div class="caption">会员等级 </div>
        <div class="tools">
            <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> 新增等级 </button>
        </div>
    </div>
