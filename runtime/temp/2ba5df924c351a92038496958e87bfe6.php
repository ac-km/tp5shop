<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"E:\WWW\tp5shop/application/admin\view\user\recharge.html";i:1480918382;s:56:"E:\WWW\tp5shop/application/admin\view\layout\layout.html";i:1480916677;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="portlet-title">
        ...
        <form class="form-inline" role="form">
            <div class="form-group">
                <label class="font-dark bold" style="margin-left:23px;"> 会员昵称 </label>
                <input type="email" class="form-control" id="nickname" placeholder="模糊查询">
            </div>
            <div class="form-group ">
                <label class="font-dark bold">时间选择</label>
            ...
            <div class="form-group ">
            <a href="javascript:;" class="btn blue"> 筛选
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    <td> 1 </td>
                    <td> hello </td>
                    <td> rechargejbddlf1476006250 </td>
                    <td> 127.00 </td>
                    <td> 2016-10-09 17:44 </td>
                    <td> 支付宝支付 </td>
                    <td> 待支付 </td>
                </tr>
                <tr>
