<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"E:\WWW\tp5shop/application/admin\view\admin\supplier.html";i:1480907763;s:56:"E:\WWW\tp5shop/application/admin\view\layout\layout.html";i:1480665142;}*/ ?>
<!DOCTYPE html>
...
<div class="portlet box light" style="margin-top: 10px;">
    <div class="portlet-title">
        <div class="caption">供应商管理 </div>
        <div class="tools">
            <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> 添加供应商</button>
        </div>
    </div>
