<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"E:\WWW\tp5shop/application/admin\view\admin\role.html";i:1480907219;s:56:"E:\WWW\tp5shop/application/admin\view\layout\layout.html";i:1480916677;}*/ ?>
<!DOCTYPE html>
...
<div class="portlet box light" style="margin-top: 10px;">
    <div class="portlet-title">
        ...
        <div class="tools">
            <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> 添加角色</button>
        </div>
    </div>
